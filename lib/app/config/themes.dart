...
class AppTheme {
  ...
  static const Color primaryAccent = Color(0xffff392b); // Was accent1
  static const Color secondaryAccent =
      Color(0xFF2196F3); // Changed to blue for distinct info messages


  // Neutral Surface Colors
  static const Color surfaceLight = Color(0xffFAFAFA); // Was surface1
  static const Color backgroundLight = Color(0xfff3f3f3); // Was bg1
  static const Color surfaceDark = Color(0xff1E1E1E); // Example dark surface
  static const Color backgroundDark =
      Color(0xff121212); // Example dark background

  // Grey Scale
  static const Color greyLight = Color(
      0xffE0E0E0); // Lighter grey (was greyWeak with a slightly different value)
  static const Color greyMedium =
      Color(0xff9E9E9E); // Mid grey (was greyMedium/onInverseSurface)
  static const Color greyDark =
      Color(0xff424242); // Darker grey (was greyStrong/inversePrimary)
  static const Color greyVeryDark =
      Color(0xff212121); // Even darker for text or dark elements

  // Semantic Colors
  static const Color errorColor =
      Color(0xFFFF002F); // Standard Material error red
  static const Color onErrorColor = Colors.white;
  static const Color successColor = Color(0xFF15B854); // Your successColor
  ...
  static Color infoColor = const Color.fromARGB(255, 126, 197, 255); // Changed to blue for distinct info messages
  static Color infoColorDark = const Color(0xFF2196F3); // Darker shade of blue for dark theme

  // Text Colors
  static const Color textPrimaryLight =
      Color(0xff212121); // Dark text on light bg
  static const Color textSecondaryLight =
      Color(0xff535353); // Lighter dark text (was grey)
  static const Color textPrimaryDark =
      Color(0xffE0E0E0); // Light text on dark bg
  ...
  */
  ...
  static Color _shiftColor(Color c, double amount, bool lighten) {
    ...
    final lightness =
        (hsl.lightness + (lighten ? amount : -amount)).clamp(0.0, 1.0);
  ...
  static ThemeData get light {
    final colorScheme = ColorScheme(
      ...
      inversePrimary: primaryAccent.withValues(
          alpha: 0.8), // For interactive elements on inverseSurface
    ...
    return ThemeData(
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        backgroundColor: _shiftColor(
            colorScheme.surface, 0.1, false), // Slightly darker surface
        contentTextStyle:
      ...
      searchBarTheme: SearchBarThemeData(
        ...
        hintStyle: MaterialStateProperty.all(textTheme.bodyMedium
      ...
      chipTheme: ChipThemeData(
        ...
        secondaryLabelStyle: textTheme.labelMedium
            ?.copyWith(color: colorScheme.onSecondary), // For selected
        padding:
            EdgeInsets.symmetric(horizontal: Insets.sm, vertical: Insets.xs),
        shape: RoundedRectangleBorder(
            borderRadius: Corners.xlBorder), // More rounded for chips
        side: BorderSide.none, // Or BorderSide(color: colorScheme.outline)
      ),
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: colorScheme.surfaceContainerHighest
            .withValues(alpha: 0.5), // Use surfaceContainerHighest
        ...
        border: OutlineInputBorder(
          ...
          borderSide:
              BorderSide(color: colorScheme.outline, width: Strokes.thin),
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: Corners.medBorder,
          borderSide:
              BorderSide(color: colorScheme.primary, width: Strokes.medium),
        ),
        errorBorder: OutlineInputBorder(
          borderRadius: Corners.medBorder,
          borderSide:
              BorderSide(color: colorScheme.error, width: Strokes.medium),
        ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          ...
          textStyle: textTheme.labelLarge
              ?.copyWith(fontWeight: FontWeight.w500), // Slightly less bold
        ),
      ),
      ...
      tabBarTheme: TabBarTheme(
        ...
        labelStyle: textTheme.titleSmall
            ?.copyWith(fontWeight: FontWeight.w600), // From textTheme
        unselectedLabelStyle: textTheme.titleSmall,
        labelColor: colorScheme.primary,
        unselectedLabelColor: colorScheme.onSurfaceVariant,
        indicator: UnderlineTabIndicator(
          borderSide:
              BorderSide(color: colorScheme.primary, width: Strokes.thick),
        ),
      ),
      tooltipTheme: TooltipThemeData(
        ...
        decoration: BoxDecoration(
          color: _shiftColor(colorScheme.surface, 0.2, false)
  ...
  static ThemeData get dark {
    final colorScheme = ColorScheme(
      ...
      primaryContainer:
          _shiftColor(primaryAccent, 0.1, false), // Darker for dark theme
      ...
      error: errorColor.withValues(
          alpha: 0.9), // Slightly desaturated/lighter error for dark
      onError: onErrorColor,
      ...
      shadow: Colors.black
          .withValues(alpha: 0.3), // Shadows are less prominent in dark usually
    ...
    return ThemeData(
      ...
      snackBarTheme: SnackBarThemeData(
        behavior: SnackBarBehavior.floating,
        backgroundColor: _shiftColor(
            colorScheme.surface, 0.1, true), // Slightly lighter surface
        contentTextStyle:
            textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface),
        shape: RoundedRectangleBorder(borderRadius: Corners.medBorder),
      ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: Corners.medBorder,
          borderSide:
              BorderSide(color: colorScheme.primary, width: Strokes.thin),
        ),
        errorBorder: OutlineInputBorder(
          borderRadius: Corners.medBorder,
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          foregroundColor: colorScheme.onPrimary,
          padding:
              EdgeInsets.symmetric(vertical: Insets.med, horizontal: Insets.lg),
          shape: RoundedRectangleBorder(borderRadius: Corners.medBorder),
          textStyle: textTheme.labelLarge,
          elevation: 2, // Elevation can be different in dark mode
          shadowColor:
              colorScheme.shadow.withValues(alpha: 0.5), // Darker shadow base
        ),
      ),
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          padding: EdgeInsets.symmetric(
              vertical: Insets.med - 2, horizontal: Insets.lg - 2),
          shape: RoundedRectangleBorder(borderRadius: Corners.medBorder),
          textStyle: textTheme.labelLarge,
        ),
      ),
      ...
      tooltipTheme: TooltipThemeData(
        ...
        margin: EdgeInsets.all(Insets.xs),
        decoration: BoxDecoration(
          color: _shiftColor(colorScheme.surface, 0.2, true)
