...
import 'package:doculode/app/config/injection_container.dart';
...
import 'package:doculode/features/setup/presentation/pages/setup_screen.dart';
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:doculode/features/dashboard/presentation/pages/dashboard_page.dart';
import 'package:doculode/app/shell/presentation/pages/shell_page.dart';
...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    redirect: (context, state) {
      ...
      final bool authUnknown = _authBloc.state.status == AuthStatus.unknown;
      final bool loggedIn = _authBloc.state.status == AuthStatus.loggedIn;
      ...
      if (loggedIn && _authBloc.state.user!.course == null && state.fullPath != Routes.setup) {
