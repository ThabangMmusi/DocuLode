...
class SecondaryBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? currentTextStyle = effectiveStyle.textStyle
        ?.resolve({}); // Try to get text style from merged style
    ...
    if (isCompact) {
      effectiveStyle = effectiveStyle.copyWith(
        padding: WidgetStatePropertyAll(
            Insets.buttonCompact), // Apply compact padding
    ...
    if (icon != null && label == null && !isLoading) {
      ...
      EdgeInsets iconOnlyPadding =
          EdgeInsets.all(isCompact ? Insets.sm : Insets.med);
      // Ensure that if a shape was provided in the instance style, it takes final precedence.
      ...
      return IconButton.outlined(
        ...
        style: effectiveStyle.copyWith(
          ...
          minimumSize:
              WidgetStatePropertyAll(Size(buttonDimension, buttonDimension)),
    ...
    if (icon != null && label == null && !isLoading) {
      ...
      final EdgeInsets iconOnlyPadding =
          EdgeInsets.all(isCompact ? Insets.xs : Insets.lg); // Match PrimaryBtn
      final double buttonDimension = iconSize + iconOnlyPadding.horizontal;
